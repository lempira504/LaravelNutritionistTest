...
<div class="container">
    ...
    <div class="row">
        ...
        <div class="col-12">
            ...
            <form action="{{ route('entrevistas.update', $appointment->id) }}" method="post">
                            ...
                            <div class="col-5 m-1 p-3" style="border:1px dashed gainsboro;">
                                ...
                                <div class="form-group">
                                    ...
                                    <input name="dob" type="date"
                                        ...
                                        placeholder="Fecha" value="{{ old('dob') ?? $interview->dob }}" autofocus>
                                ...
                                <div class="form-group">
                                    ...
                                    <input name="email" type="email"
                                        class="form-control my-input-bg @error('email') is-invalid @enderror" value="{{ old('email') ?? $interview->email }}" placeholder="Correo">

                                </div>
                                <div class="form-group">
                                    <label for="">Edad <b class="text-danger">*</b></label>
                                    <input class="form-control my-input-bg @error('age') is-invalid @enderror"
                                    value="{{ old('age') ?? $interview->age }}" type="text" name="age" id="age" placeholder="Edad">
                                    ...
                                    <div class="col">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control my-input-bg @error('cadera') is-invalid @enderror"
                                                value="{{ old('cadera') ?? $interview->cadera }}" type="text" name="cadera" id="cadera" placeholder="cms">

                                        </div>
                                        <div class="form-group">
                                            <label for="">Piernas<b class="text-danger">*</b></label>
                                            <input class="form-control my-input-bg @error('piernas') is-invalid @enderror"
                                                value="{{ old('piernas') ?? $interview->piernas }}" type="text" name="piernas" id="piernas" placeholder="cms">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input class="form-control my-input-bg @error('peso_inicial') is-invalid @enderror"
                                                value="{{ old('peso_inicial') ?? $interview->peso_inicial }}" type="text" name="peso_inicial" id="peso_inicial"
                                                placeholder="cms">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input class="form-control my-input-bg @error('grasa_corporal') is-invalid @enderror"
                                                value="{{ old('grasa_corporal') ?? $interview->grasa_corporal }}" type="text" name="grasa_corporal" id="grasa_corporal"
                                                placeholder="cms">
                                    ...
                                    <div class="col">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control my-input-bg @error('grasa_visceral') is-invalid @enderror"
                                                value="{{ old('grasa_visceral') ?? $interview->grasa_visceral }}" type="text" name="grasa_visceral" id="grasa_visceral"
                                                placeholder="cms">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input class="form-control my-input-bg @error('indice_masa_corporal') is-invalid @enderror"
                                                value="{{ old('indice_masa_corporal') ?? $interview->indice_masa_corporal }}" type="text" name="indice_masa_corporal"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input class="form-control my-input-bg @error('masa_muscular') is-invalid @enderror"
                                                value="{{ old('masa_muscular') ?? $interview->masa_muscular }}" type="text" name="masa_muscular" id="masa_muscular"
                                                placeholder="cms">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input class="form-control my-input-bg @error('talla') is-invalid @enderror"
                                                value="{{ old('talla') ?? $interview->talla }}" type="text" name="talla" id="talla" placeholder="cms">
