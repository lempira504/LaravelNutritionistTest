...
@section('title', 'Plan de '.$plan->name)
...
<div class="container">
    ...
    <div class="row">
        <div class="col-12">
            <h1 class="text-success" style="font-family: 'Oswald', sans-serif;">Detalles de {{ $plan->name }}</h1>
            <hr>
        </div>
        <div class="col-12 d-flex" style="font-family: 'Noto Sans', sans-serif;">
            ...
            <div class="pl-3">
                Telefono: <b>{{ $plan->phone }}</b>
            </div>
            <div class="pl-3">
                Correo: <b>{{ $plan->email }}</b>
            </div>
            <div class="pl-3">
                Direccion: <b>{{ $plan->address }}</b>
            </div>
        </div>
    </div>
    <div class="row py-3">
                    ...
                    <div class="col-sm-4">
                        <div class="col pb-2">
                            <img class="rounded-circle" src="https://via.placeholder.com/300.png/09f/fffC/O"
                                ...
                                <input type="hidden" name="cita_id" value="{{ $plan->id ?? old('cita_id') }}" multiple>
                        </div>
                        <div class="col text-center">
                            <hr>
                            <p>Codigo: <a class="text-success" href=""><b>{{ $plan->code }}</b></a> </p>
                        </div>
                    </div>
