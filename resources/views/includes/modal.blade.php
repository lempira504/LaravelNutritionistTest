            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    ...
                    <input name="name" type="text"
                        class="form-control my-input-bg @error('name') is-invalid @enderror" placeholder="Nombre"
                        value="{{ old('name') }}">
                ...
                <div class="form-group">
                    ...
                    <input name="date" type="date"
                        class="form-control my-input-bg @error('date') is-invalid @enderror" placeholder="Fecha"
                        value="{{ old('date') }}">
                ...
                <div class="form-group">
                    ...
                    <select name="hour_id" class="form-control @error('hour_id') is-invalid @enderror">
                        ...
                        <option value="{{ old('hour_id') ?? $availableHour->id }}">{{ $availableHour->time }}
                        </option>
                        @endforeach
